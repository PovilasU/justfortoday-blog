        ...
        <div className="col-md-10 col-lg-8 col-xl-7">
          <div className=" mt-4">
            ...
            <ul>
              ...
              <li>
                <a href="https://al-anon.lt/" target="_blank">
                  Alkoholikų artimųjų ir draugų bendrija (Al-Anon)
                </a>
              </li>
              <li>
                <a href="https://www.suaugevaikai.lt/" target="_blank">
                  Suaugę alkoholikų vaikai (SAV)
                </a>
              </li>
              <li>
